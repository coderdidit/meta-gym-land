...
import { useNFTTokenIds, useNFTTokenIds2 } from "hooks/useNFTTokenIds";
import {
  FileSearchOutlined,
  RightCircleOutlined,
...
function NFTTokenIds() {
  ...
  document.getElementById("marketplace-meny-item").onclick = () => setInputValue("explore")
  ...
  const { data: NFTTokenIds, totalNFTs, fetchSuccess } = useNFTTokenIds2(inputValue);
  console.log('fetching NFTTokenIds', NFTTokenIds, totalNFTs, fetchSuccess)
    ...
    <>
      ...
      <div>
        ...
        <div style={styles.NFTs}>
          ...
          {inputValue !== "explore" && NFTTokenIds &&
