...
function GymBuddyDetails() {
  ...
  const displayNftMeta = (nft) => {
    ...
    const snapArMinatureLink = nftMeta?.snap_ar_miniature_link ?? "";
    return (
      <>
        <section
          style={{
  ...
  if (isLoading) {
    ...
    if (!allowedNftContracts.includes(address.toLowerCase())) {
      return (
        ...
        >
          <Alert message="Incorrect NFT contract!" type="warning" />
