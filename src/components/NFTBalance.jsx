                ...
                return (
                  <>
                    <Card
                      ...
                      key={`card-${index}`}
                      actions={[
                        <Tooltip title="View On Blockexplorer" key={`view-tooltip-${index}`}>
                          <FileSearchOutlined
                            key={`FileSearchOutlined-${index}`}
                            onClick={() => window.open(`${getExplorer(chainId)}address/${nft.token_address}`, "_blank")}
                          />
                        </Tooltip>,
                        <Tooltip title="List for Sale" key={`list-tooltip-${index}`}>
                          <ShoppingCartOutlined
                            key={`ShoppingCartOutlined-${index}`}
                    ...
                    >
                      ...
                      <div
                        key={`play-with-avtr-container-${index}`}
                        style={{
                          display: "flex",
                        ...
                        <Button
                          ...
                          type="primary"
                          style={BtnPrimary}
                          key={`play-with-avtr-btn-${index}`}
                        >
                          <Link
                            to='play'
                            key={`play-with-avtr-link-${index}`}
                          >
                            Play with me
                          </Link>
                        </Button>
